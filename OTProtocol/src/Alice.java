...
/*        Security.addProvider(
    ...
    int execute() throws OTPException {
        ...
        try {
            comm_gen = KeyPairGenerator.getInstance("RSACommutative", "CSec2012");
            comm_gen.initialize(2048);
        } catch (NoSuchAlgorithmException e) {
            throw new OTPException("Commutative RSA generator not available",
                                   e);
        } catch (NoSuchProviderException e) {
            throw new OTPException("CSec2012 Provider is not available", e);
        ...
        // Step 7: Receive the decryped message and H (what did Bob call?)
